...
def bag_with_empty_directories(job, operation, destination, sip_directory, payload_entries, writer, algorithm, sip_uuid):
    ...
    for job in jobs:
        with job.JobContext():
            try:
                ...
                bag_with_empty_directories(job, args.operation, args.destination, args.sip_directory, args.payload_entries, args.writer, algorithm, args.sip_uuid)
