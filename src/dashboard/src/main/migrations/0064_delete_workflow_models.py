...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name='microservicechainlinkexitcode',
            name='nextmicroservicechainlink',
        ),
        migrations.RemoveField(
            model_name='microservicechainlinkexitcode',
            name='replaces',
        ...
        migrations.AlterField(
            model_name='job',
            name='microservicechainlink',
            field=django_extensions.db.fields.UUIDField(max_length=36, null=True, editable=False, db_column=b'MicroServiceChainLinksPK', blank=True),
        ),
        migrations.AlterField(
            model_name='unitvariable',
            name='microservicechainlink',
            field=django_extensions.db.fields.UUIDField(max_length=36, null=True, editable=False, db_column=b'microServiceChainLink', blank=True),
        ),
